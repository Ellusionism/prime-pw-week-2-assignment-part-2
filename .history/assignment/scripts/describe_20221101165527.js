...
// FIX swap the console.log values for the if and else statements, otherwise it will log `enter` when age is less than 21, and `no entry` when age is greater than 21
if(minAge <= age) {
