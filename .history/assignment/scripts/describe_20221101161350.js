...
// The console will log `How do you do?`, because `Dane`=/=`Mary`
...
// If code is equal to 123, the value of secret is set to `super`; the value of code is multiplied by two and 
//
