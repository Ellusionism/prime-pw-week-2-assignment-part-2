...
// FIX swap the value of , because otherwise it will log `enter` when age is less than 21, and `no entry` when age is greater than 21, which is the opposite of what we want
if(minAge <= age) {
