...
// FIX swap the console.log values for the if and else statements, becauseotherwise it will log `enter` when age is less than 21, and `no entry` when age is greater than 21, which is the opposite of what we want
if(minAge <= age) {
